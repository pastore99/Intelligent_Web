...
<%
    String q1 = "PREFIX vocab: <http://localhost:2020/vocab/resource/>" +
...
<div class="container-fluid">
    ...
    <div class="col-6">
        <div class="row align-items-end">
            <div class="col-2">
                <button type="button" class="btn btn-secondary w-100" onclick="addText(<%=q1%>)">Query 1</button>
        ...
        <div class="col-8">
          ...
          <div class="col-2">
              <button type="button" class="btn btn-secondary w-100" onclick="addText('Query 3')">Query 3</button>
              <button type="button" class="btn btn-secondary w-100 mt-3" onclick="addText('Query 4')">Query 4</button>
          </div>
        </div>
...
<script>
  ...
  function addText(text) {
    document.getElementById('queryArea').value = text;
  }
  ...
  var query1 = "PREFIX vocab: <http://localhost:2020/vocab/resource/>" +
  "SELECT DISTINCT ?senatore ?nome ?cognome ?inizioMandato ?legislatura ?tipoMandato"+
     " WHERE {"
      "?senatore a vocab:mytable." +
      "?senatore vocab:mytable_nome ?nome."+
